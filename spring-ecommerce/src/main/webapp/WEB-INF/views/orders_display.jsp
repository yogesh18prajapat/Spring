...
<c:forEach items="${products}" var="product">
      ...
      <div class='flex-container'>
        <div class='image' style='flex-grow: 1'><a href="product_description/${product.getProductId()}"><img src='${product.getImg()}' alt="shirt"></a>
        </div>
        ...
        <div class='content' style='flex-grow: 2'>${product.getDate()}</div>
    </div>
